...
if($request['controller']=='Paginas'):
	...
	<?php //**** JANELA MODAL MOSTRANDO QUE ALGO ESTÁ SENDO CARREGADO ****// ?>
	...
	<?php
		echo $this->Html->script(array('jquery','jquery-ui.js','dataTables','ckeditor/ckeditor'));
	?>
...
$this->end();
	...
	$this->start('script');
	echo $this->Html->script(array('jquery','jquery-ui.js','dataTables'));
	$this->end();
endif;
endif;
?>
...
DROP TABLE IF EXISTS `cms_inline_git`.`mensagens`;
DROP TABLE IF EXISTS `cms_inline_git`.`paginas`;
DROP TABLE IF EXISTS `cms_inline_git`.`seos`;
DROP TABLE IF EXISTS `cms_inline_git`.`sliders`;
DROP TABLE IF EXISTS `cms_inline_git`.`useres`;


CREATE TABLE `cms_inline_git`.`mensagens` (
...
CREATE TABLE `cms_inline_git`.`paginas` (
	`id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `cms_inline_git`.`seos` (
	`id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `cms_inline_git`.`sliders` (
	`id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `cms_inline_git`.`useres` (

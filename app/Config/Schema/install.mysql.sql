...
CREATE TABLE `seos` (
	`id` int(11) NOT NULL AUTO_INCREMENT,
	`robots` text CHARACTER SET latin1 COLLATE latin1_swedish_ci,
	`sitemap` text CHARACTER SET latin1 COLLATE latin1_swedish_ci,
...
CREATE TABLE `useres` (
	...
	`face_id` varchar(250) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
